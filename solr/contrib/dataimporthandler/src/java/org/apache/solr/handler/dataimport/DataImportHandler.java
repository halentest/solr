...
public class DataImportHandler extends RequestHandlerBase implements
  ...
  public void handleRequestBody(SolrQueryRequest req, SolrQueryResponse rsp)
    ...
    if (command != null && DataImporter.ABORT_CMD.equals(command)) {
      ...
      if (DataImporter.FULL_IMPORT_CMD.equals(command)
        ...
        importer.maybeReloadConfiguration(requestParams, defaultParams); //读取配置文件
  ...
  public String getSource() {
    return "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/lucene_solr_4_3/solr/contrib/dataimporthandler/src/java/org/apache/solr/handler/dataimport/DataImportHandler.java $";
  }
